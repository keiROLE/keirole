...
export default function AuroraBackground({
  colorStops = ["#0a3d4a", "#00e0ff", "#23ff00"],
  amplitude = 0.6,
  blend = 0.3,
  speed = 0.5,
}: AuroraProps) {
  ...
  useEffect(() => {
    ...
    // Pre-convert colors once at init time
    ...
    // Throttle resize with rAF instead of firing on every resize event
    ...
    const animLoop = () => {
      ...
      const {
        colorStops: cs = ["#0a3d4a", "#00e0ff", "#23ff00"],
        amplitude: a = 0.6,
        blend: b = 0.3,
        speed: s = 0.5,
      } = propsRef.current;
      // Use elapsed time for smooth animation regardless of frame rate
